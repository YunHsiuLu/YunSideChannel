...
fig.text(0.5, 0.01, 'Window No.', ha='center')
...
plt.title('Decrypt 1 ciphertext each window execution time')
plt.bar(x, y[0], color='r')
plt.xlabel('Window No.')
plt.ylabel('Execution Time (ns)')
plt.savefig('Single_WindowExTime.pdf')
plt.savefig('Single_WindowExTime.png')
'''
